...
const color2 = "#B408A4";
    return(
        <div   className ="hi" style={{height:'100vh'}}>
            <div>
            <h1 style={{color:"black",fontFamily:'Comic Sans MS',fontSize:50,paddingRight:1000,paddingTop: 20}}> LOGIN</h1>
            </div>
        <Grid     style={{paddingTop: 20}}>
            <Paper elevation={10} style={paperStyle}>
                ...
                <TextField label='Username' placeholder='Enter Email' fullWidth required onChange={(e) => setEmail(e.target.value)} />
                ...
                <FormControlLabel style={{marginTop:20}}
                    ...
                    label="Remember me"
                 />
                <Button type='submit' style={{backgroundColor:'black',color:'white',marginTop:10} }  variant="contained" fullWidth onClick={login}>Login</Button>
                <Typography style={{marginTop:40}} >
                     <Link style={{color:"black",fontSize:20}} href="#" >
                        Forgot password ?
                </Link>
                </Typography>
                <Typography style={{marginTop:20}}> Dont have an acount ?
