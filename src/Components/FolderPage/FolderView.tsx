...
export const FolderView = (props: FolderViewProps) => {
   ...
   return (
      <div className="main">
         ...
         <div className="flex-item"> <Typography variant="h6" component="div">
            <h3  style={{color:"black"}}>List of Projects</h3>
         </Typography></div>
         <div className="flex-item"><Button variant="contained"  style={{backgroundColor:"black",color:"white" ,width:200}}  >Add Project</Button> </div>
         
        

         <div className="flex-item">  <TextField label='Search Project' placeholder='Search Project' style={{borderRadius:'2em',width:200,marginTop:20}} /></div>
x
         ...
         <List>
            {
               data.map((item: any) => {
                  return (<ListItem className='aze' key={item.id} style={{ marginBottom: 4 }}
                     ...
                     secondaryAction={
                        ...
                        }}><EditIcon style={{color:"green"}}/></Button>
                              <Button><VisibilityIcon style={{color:"blue"}}/></Button>
                           </ButtonGroup>
